...
<div id="frameContent" class="content-wrapper" style="margin-left:0px;">
    ...
    <!-- 内容头部 /-->
    <form id="editForm" action="${ctx}/cargo/packing/edit.do?packingListId=${pack.packingListId}" method="post">
        ...
        <section class="content">
            <div class="panel panel-default">
                ...
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-4 data">
                        <input type="text" name="invoiceNo" class="form-control" placeholder="发票号"value="${pack.invoiceNo}"/>
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <div class="input-group date">
                            ...
                            <input type="text" placeholder="发票日期"  name="invoiceDate" class="form-control pull-right"
                                   value="<fmt:formatDate value="${pack.invoiceDate}" pattern="yyyy-MM-dd"/>" id="invoiceDate">
                        </div>
                    </div>
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <c:forEach items="${page}" var="o" varStatus="status">
                                <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
                                    <td><input type="checkbox" name="exportIds"
                                      <c:if test="${fn:contains(ids,o.id)}">checked</c:if>
                                               value="${o.id}"/></td>
                                    <td>${o.id}</td>
                                    <td align="center">
                                            ${o.proNum}/${o.extNum}
